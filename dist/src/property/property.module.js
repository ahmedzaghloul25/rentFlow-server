...
exports.PropertyModule = PropertyModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [property_service_1.PropertyService, repo_1.PropertyRepo, repo_1.ContractRepo, repo_1.UserRepo, services_1.JwtToken, jwt_1.JwtService, common_1.Logger],
        exports: [repo_1.ContractRepo, common_1.Logger]
    })
], PropertyModule);
